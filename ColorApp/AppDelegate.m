...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"SavedHues" withExtension:@"momd"];
...
// TODO: remove this method once old Core Data Stack is removed
- (void)saveContext {
